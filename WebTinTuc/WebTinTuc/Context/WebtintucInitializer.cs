...
namespace WebTinTuc.Context
{
    public class WebtintucInitializer : System.Data.Entity.DropCreateDatabaseIfModelChanges<WebtintucContext>
    {
        protected override void Seed(WebtintucContext context)
        {
            ...
            {
            new Account{AccountID=1, Username="admin",Password="e10adc3949ba59abbe56e057f20f883e",MemberID=1,Decendalization="Admin",RegistrationDate=DateTime.Parse("2005-09-01"),Status="Hoạt động"},
            new Account{AccountID=2, Username="gm1",Password="e10adc3949ba59abbe56e057f20f883e",MemberID=2,Decendalization="Quản lý chuyên mục",RegistrationDate=DateTime.Parse("2005-09-01"),Status="Hoạt động"},
            new Account{AccountID=3, Username="gm2",Password="e10adc3949ba59abbe56e057f20f883e",MemberID=3,Decendalization="Viết bài",RegistrationDate=DateTime.Parse("2005-09-01"),Status="Hoạt động"}
            };
